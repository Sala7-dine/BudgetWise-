...
class GeminiService
{
    ...
    public function getSuggestions($depenses, $depensesRecurrentes, $budget){
        ...
        $prompt = "J'ai un budget mensuel de {$budget} MAD.
                    ...
                    et optimiser ma gestion financière (dans 4 phrases au maximum, et je veux les consiels sous comme :  'Wow, 600 DH en Divertissement? Essaye des alternatives gratuites pour économiser.' ? si mon salaire est 0 dans ce message , dis moi aucun conseil n'est disponible.";
